...
if calculation_type == "Audit":
    ...
    if calculate:
        ...
        # Visualization
        fig, ax = plt.subplots()
        ax.bar(["Audit Risk"], [audit_risk], color='b')
        ax.set_ylabel('Risk Percentage')
        ax.set_title('Audit Risk')
        st.pyplot(fig)
    ...
    if calculate:
        ...
        # Visualization
        fig, ax = plt.subplots()
        ax.bar(["Assurance Percentage", "Estimated Error"], [assurance_percentage, estimated_error], color='g')
        ax.set_ylabel('Percentage')
        ax.set_title('Assurance Metrics')
        st.pyplot(fig)
